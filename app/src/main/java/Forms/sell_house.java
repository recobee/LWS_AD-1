...
import com.livingwordsolutions.technosoft.post_module_location.Task_async.sell_house_task;
 ...
 */
public class sell_house extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new sell_house_task(getActivity(), phone.getText(), cons_t.getText(),submitter.getSelectedItem()).execute();
