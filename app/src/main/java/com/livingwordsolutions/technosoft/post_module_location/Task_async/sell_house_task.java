...
public class sell_house_task extends AsyncTask<String, String, String> {
    ...
    public sell_house_task(Context context, Object... objects) {
    ...
    protected void onPreExecute() {
        ...
        pDialog.setTitle("Sell House Details");
